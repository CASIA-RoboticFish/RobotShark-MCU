...
* @Description: 
********************************************************************************/
#ifndef __2DOF_GIMBAL_FUZZY_CONTROL_H_
#define __2DOF_GIMBAL_FUZZY_CONTROL_H_
...
// 反馈P  10-20
// 反馈D  1-1.5
static const float fuzzy_rule_kp[7] = {NL,NL,NM,ZE,PM,PL,PL};
static const float fuzzy_rule_kd[7] = {NL,NL,NM,ZE,PM,PL,PL};
static const float fuzzy_rule_fp[7] = {PL,PL,PS,ZE,NS,NL,NL};
...
********************************************************************************/
// 配置云台控制任务
#define GIMBAL_CONTROL_TASK_PRIO 6
#define GIMBAL_CONTROL_STK_SIZE 512
void gimbal_control_task(void *p_arg);

// 云台控制唤醒定时器
#define GIMBAL_CONTROL_TIMER_PERIOD_MS 1  // 20ms的控制周期和IMU数据的周期是一致的
#define GIMBAL_CONTROL_TIMER_PERIOD_TICKS (((uint32_t)GIMBAL_CONTROL_TIMER_PERIOD_MS*1000)/OS_CFG_TMR_TASK_RATE_HZ)
